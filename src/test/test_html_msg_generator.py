...
class TestStringMethods(unittest.TestCase):
    ...
    def test_alici_unvani(self):
        ...
        self.EXPECTED_LINE = 155
        self.EXPECTED_VALUE = "<strong>Serkan AYAS</strong>"
